...
import { updateStart, updateSuccess, updateFailure, deleteUserSuccess, deleteUserStart, deleteUserFailure } from "../redux/user/userSlice";
            ...
            {updateUserSuccess && (
             ...
             >
                ...
                <div className="text-center">
                    ...
                    <h3 className="mb-5 text-lg text-gray-500 dark:text-gray-400" >Are yu sure you want to delete your account?</h3>
